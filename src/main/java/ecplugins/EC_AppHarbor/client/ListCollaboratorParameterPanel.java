...
// ListCollaboratorParameterPanel.java --
//
// ListCollaboratorParameterPanel.java is part of ElectricCommander.
//
 ...
 * real function.
 */
public class ListCollaboratorParameterPanel
        ...
        ParameterPanelProvider
{
    ...
    // ~ Static fields/initializers----------------------------
    private static UiBinder<Widget, ListCollaboratorParameterPanel> s_binder =
    ...
    @Override public Widget doInit()
    {
        ...
        Action.addItem("List Collaborators", "list");
        Action.addItem("Get Collaborator Detail", "get");
        ...
        LCParameterForm.addRow(true, "Action:",
            "Select the Action to perform, the options are: List Collaborators and Get Collaborator Detail.",
            ACTION, "list", Action);
        LCParameterForm.addRow(true, "Application Slug:",
            "The globally unique, URL-friendly version of the application name.",
            APPSLUG, "", new TextBox());
        LCParameterForm.addRow(false, "Collaborator:",
            "Specifies the collaborator identifier.", COLLABORATOR, "",
            new TextBox());
    ...
    @Override public boolean validate()
    {
        ...
        if ((action.equals("get"))
                && (StringUtil.isEmpty(
                        LCParameterForm.getValue(COLLABORATOR)
                                   .trim()))) {
            LCParameterForm.setErrorMessage(COLLABORATOR,
                "This Field is required.");
            validationStatus = false;
        }
    ...
    private void updateRowVisibility()
    {
        ...
        LCParameterForm.setRowVisible(COLLABORATOR, "get".equals(action));
    }
    ...
    @Override public Map<String, String> getValues()
    {
        ...
        actualParams.put(COLLABORATOR, searchFormValues.get(COLLABORATOR));
    ...
    interface Binder
        extends UiBinder<Widget, ListCollaboratorParameterPanel> { }
}
