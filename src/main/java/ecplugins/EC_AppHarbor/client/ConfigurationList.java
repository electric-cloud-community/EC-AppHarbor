...
/**
 * EC-AppHarbor Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private AppHarborConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "AppHarbor Configurations", "All Configurations");
        m_configList = new AppHarborConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        AppHarborConfigListLoader loader = new AppHarborConfigListLoader(
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-AppHarbor/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the AppHarbor configuration '"
                            + configName + "'?") {
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "AppHarborMonitor.cgi");
