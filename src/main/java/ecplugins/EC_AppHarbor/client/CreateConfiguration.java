...
/**
 * Create AppHarbor Configuration.
 */
    ...
    extends InternalFormBase
{
    ...
    {
        super("New AppHarbor Configuration", "AppHarbor Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-AppHarbor"
                + "/project/ui_forms/EC-AppHarbor - AppHarborCreateConfigForm");
        loader.load();
        clearStatus();
    }
