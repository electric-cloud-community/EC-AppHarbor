...
my $xpath    = $ec->getProperty("/myProject/AppHarbor_cfgs/$opts->{config}");
...
my $cfg = new ElectricCommander::PropDB($ec, "/myProject/AppHarbor_cfgs");
